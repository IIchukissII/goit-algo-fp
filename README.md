...
- bfs_iterative() - Пошук у ширину (BFS) відрізняється від DFS тим, що він відвідує всі вершини на певному рівні перед тим, як перейти до наступного рівня
...
- heappop() - Видаляє і повертає найменший чи найменший елемент купи, в залежності від її виду.
